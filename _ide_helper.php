...
namespace {
	...
	class Redirect extends \Illuminate\Support\Facades\Redirect{
		 ...
		 * @static 
		 */
		 public static function back($default = '/', $status = 302, $headers = array()){
			//Method inherited from \Illuminate\Routing\Redirector
			return \Illuminate\Routing\Redirector::back($default, $status, $headers);
		 }
	...
	class URL extends \Illuminate\Support\Facades\URL{
		 ...
		 * @static 
		 */
		 public static function route($name, $parameters = array(), $absolute = false, $route = null){
			//Method inherited from \Illuminate\Routing\UrlGenerator
		 ...
		 * @static 
		 */
		 public static function action($action, $parameters = array(), $absolute = false){
			//Method inherited from \Illuminate\Routing\UrlGenerator
	...
	class Slug extends \Ivanlemeshev\LaravelCyrillicSlug\Facades\Slug {
		/**
		...
		public static function make($title, $separator = '-'){
			return \Ivanlemeshev\LaravelCyrillicSlug\Slug::make($title, $separator = '-');
		}
	}
	class Sluggable extends \Cviebrock\EloquentSluggable\Facades\Sluggable {}
}
